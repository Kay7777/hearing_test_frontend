        ...
        <TableBody>
          {
            Object.keys(props.questions).map((q, key) => {
              const grey = key % 2 === 0;
              if (grey) {
                return <TableRow key={key} style={{backgroundColor: "#e9ecef"}}>
                <TableCell align="left">{key+1}.</TableCell>
                <TableCell align="left">{q}</TableCell>
                <TableCell align="left">
                  <div className="row">
                    <button style={{border: "none", backgroundColor: "#e9ecef"}} onClick={() => props.onChoiceClick(q, "without", "A")}>A</button>
                    <button style={{border: "none", backgroundColor: "#e9ecef"}} onClick={() => props.onChoiceClick(q, "without", "B")}>B</button>
                    <button style={{border: "none", backgroundColor: "#e9ecef"}} onClick={() => props.onChoiceClick(q, "without", "C")}>C</button>
                    <button style={{border: "none", backgroundColor: "#e9ecef"}} onClick={() => props.onChoiceClick(q, "without", "D")}>D</button>
                    <button style={{border: "none", backgroundColor: "#e9ecef"}} onClick={() => props.onChoiceClick(q, "without", "E")}>E</button>
                    <button style={{border: "none", backgroundColor: "#e9ecef"}} onClick={() => props.onChoiceClick(q, "without", "F")}>F</button>
                    <button style={{border: "none", backgroundColor: "#e9ecef"}} onClick={() => props.onChoiceClick(q, "without", "G")}>G</button>
                  </div>
                </TableCell>
                <TableCell align="left">
                  <div className="row">
                    <button style={{border: "none", backgroundColor: "#e9ecef"}} onClick={() => props.onChoiceClick(q, "with", "A")}>A</button>
                    <button style={{border: "none", backgroundColor: "#e9ecef"}} onClick={() => props.onChoiceClick(q, "with", "B")}>B</button>
                    <button style={{border: "none", backgroundColor: "#e9ecef"}} onClick={() => props.onChoiceClick(q, "with", "C")}>C</button>
                    <button style={{border: "none", backgroundColor: "#e9ecef"}} onClick={() => props.onChoiceClick(q, "with", "D")}>D</button>
                    <button style={{border: "none", backgroundColor: "#e9ecef"}} onClick={() => props.onChoiceClick(q, "with", "E")}>E</button>
                    <button style={{border: "none", backgroundColor: "#e9ecef"}} onClick={() => props.onChoiceClick(q, "with", "F")}>F</button>
                    <button style={{border: "none", backgroundColor: "#e9ecef"}} onClick={() => props.onChoiceClick(q, "with", "G")}>G</button>
                  </div>
                </TableCell>
              </TableRow>
              } else {
