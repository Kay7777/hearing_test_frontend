...
import Welcome from "../../components/crm3/pre-test/welcome";
import AudioLoss1 from "../../components/crm3/test/audioloss1";
import AudioLoss2 from "../../components/crm3/test/audioloss2";
import Source1 from "../../components/crm3/test/source1";
import Source2 from "../../components/crm3/test/source2";
import Adjustment from "../../components/crm3/pre-test/adjustment";
import Questions from "../../components/crm3/pre-test/questions";
import Test from "../../components/crm3/test/test";
import End from "../../components/crm3/post-test/end";
import ICF from "../../components/crm3/pre-test/ICF";
import DemoInfo from "../../components/crm3/pre-test/demo-info";
import MidPage from "../../components/crm3/test/mid-page";
import PostQuestion1 from "../../components/crm3/post-test/questions1";
import PostQuestion2 from "../../components/crm3/post-test/questions2";
import PostQuestion3 from "../../components/crm3/post-test/questions3";
import PostQuestion4 from "../../components/crm3/post-test/questions4";
...
class Main extends React.Component {
  ...
  componentDidMount = async () => {
    const doc = await axios.get("/api/crm3/reversals");
  ...
  handleSubmit = async (callback) => {
    ...
    await axios.post("/api/crm3/user/data", {
